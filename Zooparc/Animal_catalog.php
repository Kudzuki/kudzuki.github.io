            ...
            <?php
                ...
                foreach($line2 as $mas) {
                    ...
                    <div class="service-item">
                        <h2>'. $mas['name'] . '</h2>
                        <br>
                        <img src="./img/'. $mas['img']. '" alt="'. $mas['name']. '">
                        <p> Описание: '. $mas['Short_Text'] . '</p>
                        <p class="price"> Количество: '. $mas['quantity'] . ' особей.</p>
                        <p> Номер вальера: '. $mas['cell_number'] . '</p>
                        <form method="post">
                            <input type="hidden" name="service_id" value="'. $mas['id']. '">
                            <input type="submit" value="Подробно" class="submit">
                        </form>
                    </div>';
